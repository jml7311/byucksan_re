$(document).ready(function() {
    ...
    function snbLine(){
        ...
        let snbOnLength = $('.snb li.on').length;

        if(snbLength > 0 && snbOnLength > 0){
    ...
    /* 회원가입 파일선택 */
    $('#photo').chabilize(function(){
        // let filePath = $(this).val()
        //     filePath = filePath.split('\\')
        // let fileLength = filePath.length; //3

        // $('.file_name').text(filePath[filePath-1]);
    ...
    console.log(spotmenuHtml);  // spotmenuHtml 내용 확인
$('.mo_spotmenu').html(spotmenuHtml);
console.log($('.mo_spotmenu').html()); 
